...
function MainFunctions:PrepareHitboxes()
	for _, button in ipairs({
		self.UI.CloseButton,
		self.UI.ReturnButton,
		self.UI.NavButton,
		self.UI.WindowButton,
		self.UI.FullscreenButton,
		self.UI.DragHandle,
		self.UI.ResizeHandle,
	}) do
		if button then
			button.Active = true
			button.Selectable = true
	...
	if self.UI.Controls then
		self.UI.Controls.Active = false
		self.UI.Controls.Selectable = false
	end

	if self.UI.Sidebar then
		self.UI.Sidebar.Active = false
		self.UI.Sidebar.Selectable = false
	end
end
