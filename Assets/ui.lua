...
function UI.CreateBase(title, versionText)
    ...
    G2L["logo_text"] = New("TextLabel", {
        ...
        Text = string.format("<font color=\"rgb(248, 191, 212)\">Goon</font>Hub <font color=\"rgb(150,150,150)\">| %s</font> <font color=\"rgb(100,100,100)\" size=\"12\">%s</font>", title, versionText),
        RichText = true,
        FontFace = fonts.logo,
        TextSize = 21,
    ...
    New("UIListLayout", {VerticalAlignment = Enum.VerticalAlignment.Center}, info)
    New("UIFlexItem", {FlexMode = Enum.UIFlexMode.Fill}, info)
    ...
    New("UICorner", {CornerRadius = UDim.new(0, 4)}, tBox)
    New("UIPadding", {
        PaddingLeft = UDim.new(0, 8),
        PaddingRight = UDim.new(0, 8)
    }, tBox)
