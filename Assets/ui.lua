...
-- Funktionen aus mainfunction.lua laden und auf die UI-Elemente anwenden
local success, mainFunctions = pcall(function()
    local path = "GoonHub/Assets/mainfunction.lua"
...
if success and mainFunctions and mainFunctions.Apply then
    mainFunctions.Apply(G2L)
end
