...
function Widgets.Init(window, G2L)
    ...
    function window:CreateTab(name, isFixed)
        ...
        function tObj:CreateSection(title, column)
            ...
            local secFrame = New("Frame", {Name = "Section", Size = UDim2.new(1, -10, 0, 32), AutomaticSize = Enum.AutomaticSize.Y, BackgroundColor3 = Color3.fromRGB(30, 30, 30), ClipsDescendants = false, LayoutOrder = self.SectionCount}, self[col])
