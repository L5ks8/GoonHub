...
Modules.ChangeColor()
Modules.print("Green", "[Slime RNG]: [   SUCCESS   ] - Authenticated in (" .. LoadTime .. "s)")

local UILayout = GoonHub.Import("Scripts/8f3b2c7d1a9e4f60bc2d5a7e18c4d9f1/Components/uilayout")
