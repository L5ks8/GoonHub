...
task.delay(0.1, function()
    Modules.print("Green", "[Attack on Titan Revolution]: [   SUCCESS   ] - Authenticated in (" .. LoadTime .. "s)")
end)

-- UI laden
local UILayout = GoonHub.Import("Scripts/5e8c1d7f2ab34960cde4719fa862b3d0/Components/uilayout")
