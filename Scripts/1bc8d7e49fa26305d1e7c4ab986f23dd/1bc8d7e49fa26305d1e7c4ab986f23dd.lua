...
local UILayout = GoonHub.Import("Scripts/1bc8d7e49fa26305d1e7c4ab986f23dd/Components/uilayout")
...
Modules.ChangeColor()
Modules.print("Green", "[Be a Lucky Block]: [   SUCCESS   ] - Authenticated in (" .. LoadTime .. "s)")