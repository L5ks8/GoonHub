...
-- UI laden
local UILayout = GoonHub.Import("Scripts/f9c1d7a4be826305de471fa98b2c63dd/Components/uilayout")
local window = UILayout.Create()

local FinalLoadTime = string.format("%.2f", tick() - StartTime)
Modules.print("Green", "[Shindo Life]: [   SUCCESS   ] - Authenticated in (" .. FinalLoadTime .. "s)")
