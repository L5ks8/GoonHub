...
local UILayout = GoonHub.Import("Scripts/f2a7c49d81be6035dce91a47b8f26d3e/Components/uilayout")
...
Modules.ChangeColor()
Modules.print("Green", "[Be a Brainrot]: [   SUCCESS   ] - Authenticated in (" .. LoadTime .. "s)")