...
local UILayout = GoonHub.Import("Scripts/3fa7d1c9e4b86205ad71fc48b26e93cc/Components/uilayout")
...
Modules.ChangeColor()
Modules.print("Green", "[Escape Tsunami]: [   SUCCESS   ] - Authenticated in (" .. LoadTime .. "s)")