...
local sharedUiFolder = scriptsFolder:WaitForChild("Ui")
local sharedUiModule = sharedUiFolder:FindFirstChild("ui") or sharedUiFolder:FindFirstChild("ui.lua")

if not sharedUiModule then
	error("Shared UI module was not found in Scripts/Ui")
end

local SharedUi = require(sharedUiModule)
